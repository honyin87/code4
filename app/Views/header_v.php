...
<html lang="en">
  <head>
    ...
    <!-- Layout style -->
    <link rel="stylesheet" href="<?php echo base_url();?>/assets/css/base/style.css">
    <!-- Layout style -->
    ...
    <nav class="t-header">
      <div class="t-header-brand-wrapper">
        <a href="index.html">
          ...
          <img class="logo-mini" src="<?php echo base_url();?>/assets/images/logo_mini.svg" alt="">
        </a>
                ...
                <div class="dropdown-body">
                  <div class="dropdown-list">
                    <div class="image-wrapper">
                      <img class="profile-img" src="<?php echo base_url();?>/assets/images/profile/male/image_1.png" alt="profile image">
                  ...
                  <div class="dropdown-list">
                    <div class="image-wrapper">
                      <img class="profile-img" src="<?php echo base_url();?>/assets/images/profile/female/image_2.png" alt="profile image">
                      <div class="status-indicator rounded-indicator bg-success"></div>
                    </div>
                    <div class="content-wrapper">
                  ...
                  <div class="dropdown-list">
                    <div class="image-wrapper">
                      <img class="profile-img" src="<?php echo base_url();?>/assets/images/profile/male/image_3.png" alt="profile image">
